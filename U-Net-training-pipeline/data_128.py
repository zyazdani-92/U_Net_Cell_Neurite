'''
This .py file ensures data adjustment and augmentation for the training pipeline, making training and validation samples compatible for the U-Net down and up sampling blocks. 
...
def saveResult(save_path,npyfile,file_list,flag_multi_class = False,num_class = 2):
    for i,item in enumerate(npyfile):
        ...
        filename = os.path.join(save_path,os.path.splitext(file_list[i])[0]+".tif") #"_predict.png"
