...
NUM_EPOCHS=50
BATCH_SIZE = 2
NUM_TRAIN_IMAGES= 440
NUM_VAL_IMAGES= 110
save_to_diri = "Img-Cells/save_path" 
# data augmentation
...
trainGene = trainGenerator(BATCH_SIZE,'Img-Cells/train','img_aug','mask_aug',data_gen_args,save_to_dir = save_to_diri)
valGene = valGenerator(BATCH_SIZE,'Img-Cells/val','img_aug','mask_aug',data_gen_args)
